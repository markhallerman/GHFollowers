...
class UserInfoVC: UIViewController {
    ...
    func configureUIElements(with user: User) {
        ...
        self.add(childVC: GFRepoPanelVC(user: user, delegate: self), to: self.infoPanelOne)
        self.add(childVC: GFFollowerPanelVC(user: user, delegate: self), to: self.infoPanelTwo)
