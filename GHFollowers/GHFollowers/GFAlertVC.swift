...
class GFAlertVC: UIViewController {
    ...
    let actionButton = GFButton(backgroundColor: .systemPink, title: AppStrings.ok)
    ...
    func configureTitleLabel() {
        titleLabel.text = alertTitle ?? AppStrings.unexpectedError
    ...
    func configureActionButton() {
        actionButton.setTitle(buttonTitle ?? AppStrings.ok, for: .normal)
